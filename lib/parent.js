(function() {
  ...
  (function(window, document) {
    var Base, BaseLogging, Exception, Notify, ParentClient, parseUri, toCamelCase, toUnderscore, urlEncode;
    ...
    parseUri = function(url) {
      var key, keys, parser, part, result, search, value, _i, _j, _key, _len, _len1, _ref, _ref1, _value;
      result = {};
        ...
        if (key === 'search') {
          ...
          if (result[key]) {
            ...
            for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
              part = _ref[_j];
              _ref1 = part.split('='), _key = _ref1[0], _value = _ref1[1];
